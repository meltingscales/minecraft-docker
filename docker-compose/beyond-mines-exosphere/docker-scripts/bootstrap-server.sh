...
SOURCE_DIR="/minecraft-unzipped/BM_Exosphere_2.0.2_server" # we do have a subpath here because this specific modpack author does NOT unzip the server files into the root of the zip
